...
const bundles: Bundle[] = [
  { sku: "STKZ_10000", amount: 199, price: "£1.99" },
  { sku: "STKZ_30000", amount: 499, price: "£4.99" },
  { sku: "STKZ_75000", amount: 999, price: "£9.99" },
  { sku: "STKZ_175000", amount: 1999, price: "£19.99" },
];
    ...
    <main className="min-h-screen bg-[#120b20] px-4 py-6 text-[#fff8f2] sm:px-8 lg:px-12">
      <div className="mx-auto max-w-6xl">
        <header className="flex flex-wrap items-center justify-between gap-4">
          <div>
            ...
            <p className="mt-2 max-w-2xl text-sm leading-6 text-[#b9a9c5]">
              Buy permanent celebrity packs or add closed-loop STKZ. For the market simulation, £1 is valued at 100 STKZ. STKZ remains an in-game currency only and cannot currently be withdrawn, redeemed or exchanged for cash.
            </p>
          </div>
          <WalletBalance />
        </header>
        ...
        <section className="mt-8 rounded-[28px] border border-[#ffd17b]/25 bg-[#211230] p-5 sm:p-7">
          ...
          <p className="mt-2 text-sm text-[#b9a9c5]">Top-ups use £1 = 100 STKZ: £9.99 adds 999 STKZ. Purchased STKZ never expires and any unspent paid balance survives an account reset.</p>
          <div className="mt-5 grid gap-3 sm:grid-cols-2 lg:grid-cols-4">
            {bundles.map((bundle) => (
              <article key={bundle.sku} className="rounded-2xl border border-white/10 bg-[#160c25] p-4">
                <p className="font-display text-2xl font-black">{bundle.amount.toLocaleString("en-GB")}</p>
                <p className="text-xs font-bold text-[#c99bff]">STKZ · £1 = 100 STKZ</p>
                <button
                  type="button"
        ...
        <section className="mt-6 rounded-[28px] border border-[#ff7282]/30 bg-[#2d1428] p-5 sm:p-7">
          ...
          <p className="mt-2 max-w-2xl text-sm leading-6 text-[#d6c6d4]">Reset your game back to the £1-equivalent starting balance: 100 base STKZ. Your permanent pack unlocks remain yours and any unspent purchased STKZ is added on top of the fresh 100.</p>
