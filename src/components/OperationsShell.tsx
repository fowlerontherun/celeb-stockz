...
import { Activity, BadgePoundSterling, Database, LockKeyhole, PackageOpen } from "lucide-react";
import { Link, useLocation } from "react-router-dom";

const tabs = [
  { to: "/operations", label: "Operations", icon: Activity },
  { to: "/operations/profitability", label: "Profitability", icon: BadgePoundSterling },
